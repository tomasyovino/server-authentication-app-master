...
export const createUser = async (username, email, password, roles, firstName, lastName, phone) => {
    const user = await userDAO.createUser(username, email, password, roles, firstName, lastName, phone);
    return user;
};
