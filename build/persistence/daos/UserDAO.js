...
var _RoleDAO = _interopRequireDefault(require("./RoleDAO"));
...
var instance = null;
var UserDAO = /*#__PURE__*/function (_DAOContainer) {
  _inherits(UserDAO, _DAOContainer);
  var _super = _createSuper(UserDAO);
  function UserDAO() {
    _classCallCheck(this, UserDAO);
    return _super.call(this, _User.UserModel);
  }
  _createClass(UserDAO, [{
    key: "createUser",
    value: function () {
      var _createUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(username, email, password, roles, firstName, lastName, imgUrl, phone) {
        var roleDAO, foundRoles, newUser, savedUser;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              roleDAO = _RoleDAO["default"].createInstance();
              _context.t0 = _User.UserModel;
            ...
            case 22:
              ;
              _context.next = 25;
              return foundRoles.map(function (role) {
                return role._id;
              });
            case 25:
              newUser.roles = _context.sent;
              _context.next = 28;
              return newUser.save();
            case 28:
      ...
      function createUser(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8) {
