...
userRouter.get('/:id', _middlewares.verifyToken, usersCtrl.getUserByIdController);
...
userRouter.put('/:id', [_middlewares.verifyToken, _middlewares.upload.single('image')], usersCtrl.updateUserByIdController);
